...
def sample_cond(config):
    ...
    vae = VAE.load_from_checkpoint(
        ...
        max_epochs=config_vae.model.epochs,
        enc_block_str=config_vae.model.enc_block_config_str,
        dec_block_str=config_vae.model.dec_block_config_str,
        enc_channel_str=config_vae.model.enc_channel_config_str,
        dec_channel_str=config_vae.model.dec_channel_config_str,
        attributes=config_vae.model.attributes,
    )
    vae.eval()
    ...
    ddpm_wrapper = DDPMWrapper.load_from_checkpoint(
        ...
        add_variation = config_ddpm.evaluation.add_variation,
        attribute_index = config_ddpm.evaluation.attribute_index,
        normal_mean = config_ddpm.evaluation.normal_mean,
        normal_std = config_ddpm.evaluation.normal_std
    )
    # Create predict dataset of latents
    z_dataset = LatentDataset(
        (n_samples, config_vae.model.z_dim, 1, 1),
        (n_samples, config_vae.data.n_channels, image_size, image_size),
