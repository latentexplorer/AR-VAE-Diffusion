...
def train(config):
    ...
    dataset = get_dataset(d_type, root, image_size, attributes=config.training.attributes, attribute_data=config.training.alsr_csv, norm=False, flip=config.data.hflip)
    N = len(dataset)
    ...
    vae = VAE(
        ...
        alpha_start=config.training.alpha_start,
        alpha_stop=config.training.alpha_stop,
        n_cycle=config.training.n_cycle,
        ratio=config.training.ratio,
        attributes=config.training.attributes,
